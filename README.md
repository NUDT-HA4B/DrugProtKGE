# Pairwise Triple Similarity Scores for Drug-Protein Interaction Embedding
This repository contains the data and code to support the experiments found in "DrugProtKGE: Weakly Supervised Knowledge Graph Embedding for Highly-Effective Drug-Protein Interaction Representation".
...
Next, cd to ```src/pytorch_models``` and download the pre-trained models for ChemProt and DrugProt found here (https://drive.google.com/file/d/1E7RiTevuwQAsk9xxzHmHCmqIa7dWau15/view?usp=sharing).
